...
(function (GameTheme) {
    ...
    GameTheme["ANIMALS"] = "animals";
    GameTheme["NUMBERS"] = "numbers";
})(GameTheme || (GameTheme = {}));
var GameState;
(function (GameState) {
    GameState["WAITING"] = "waiting";
    GameState["COMPARING"] = "comparing";
    GameState["GAME_OVER"] = "gameOver";
})(GameState || (GameState = {}));
// Game class to manage the state and logic
class MemoryGame {
    constructor() {
        this.cards = []; // Array of all cards in the game
        this.players = []; // Array of players
        this.flippedCards = []; // Currently flipped cards
        this.currentPlayerIndex = 0; // Index of the current player
        this.gameState = GameState.WAITING; // Current state of the game
        this.matchedPairs = 0; // Number of matched pairs
        this.hintsRemaining = 3; // Number of hints remaining
    ...
    initEventListeners() {
        ...
        (_a = document
            .getElementById("startGame")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => this.startGame());
        (_b = document
            .getElementById("pairSlider")) === null || _b === void 0 ? void 0 : _b.addEventListener("input", (e) => this.updatePairCount(e));
        (_c = document
            .getElementById("playerSlider")) === null || _c === void 0 ? void 0 : _c.addEventListener("input", (e) => this.updatePlayerCount(e));
        // Theme selection
        ...
        // Hint button
        (_d = document
            .getElementById("hintBtn")) === null || _d === void 0 ? void 0 : _d.addEventListener("click", () => this.useHint());
    }
    updatePairCount(e) {
    ...
    resetGame() {
        ...
        document.getElementById("hintRemaining").textContent = `${this.hintsRemaining}`;
    }
    createPlayers() {
    ...
    handleCardClick(card) {
        ...
        if (this.gameState === GameState.COMPARING || // Ignore clicks during comparison
    ...
    endGame() {
        ...
        document.getElementById("message").innerHTML = `<h3>🎉 Game Over! 🎉</h3><p>${message}</p>`;
    }
    useHint() {
